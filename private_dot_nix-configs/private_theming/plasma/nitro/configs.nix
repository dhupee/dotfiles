{
  programs.plasma = {
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/dhupee\\/Projects\\/dotfiles-old\\/private_dot_config\\/nvim\\/init.lua"."TextFolding" = "{\"checksum\":\"2514f9ed90d831793ec8b5ca4666040996d01e09\",\"ranges\":[]}";
