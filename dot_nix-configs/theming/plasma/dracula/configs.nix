{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."PoloniumRetileWindow" = ",none,Polonium: Retile Window";
    ...
    configFile = {
      ...
      "spectaclerc"."ImageSave"."lastImageSaveLocation" = "file:///home/dhupee/Pictures/Screenshots/Screenshot_20250323_171708.png";
