{
  programs.plasma = {
    ...
    configFile = {
      ...
      "kdeglobals"."DirSelect Dialog"."Splitter State" = "\x00\x00\x00\xff\x00\x00\x00\x01\x00\x00\x00\x02\x00\x00\x00\xa0\x00\x00\x02\xa8\x00\xff\xff\xff\xff\x01\x00\x00\x00\x01\x00";
      ...
      "kwinrc"."Activities/LastVirtualDesktop"."3f65f208-f25c-4062-8133-10dc1e69f7de" = "6905dd43-cda0-464b-acf0-265c80a84bab";
      ...
      "kwinrc"."Tiling/5f1f82cd-2512-560b-90ca-a5b0fb68e3fa"."tiles" = "{\"layoutDirection\":\"floating\",\"tiles\":[]}";
      "kwinrc"."Tiling/d3efedd5-ae5f-5319-a307-a645dd85a982"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[]}";
